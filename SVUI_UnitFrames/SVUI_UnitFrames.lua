	...
	if(PORTRAIT_GRIP) then
		...
		if(PORTRAIT_ENABLED) then
			...
			if(PORTRAIT_OVERLAY) then 
				...
				PORTRAIT_GRIP:ModPoint(TOP_ANCHOR2, MASTER_GRIP, TOP_ANCHOR2, (1 * TOP_MODIFIER), -1)
				PORTRAIT_GRIP:ModPoint(BOTTOM_ANCHOR2, MASTER_GRIP, BOTTOM_ANCHOR2, (1 * BOTTOM_MODIFIER), 1)
