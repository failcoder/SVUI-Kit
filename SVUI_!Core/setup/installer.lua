...
function SV.Setup:Install(autoLoaded)
	...
	if not SVUI_InstallerFrame then 
		...
		frame.Next.texture:SetTexture(SV.Media.setup.arrow)
		...
		frame.Prev.texture:SetTexture(SV.Media.setup.arrow)
		...
		frame.Option01.texture:SetTexture(SV.Media.setup.option)
		...
		frame.Option02.texture:SetTexture(SV.Media.setup.option)
		...
		frame.Option03.texture:SetTexture(SV.Media.setup.option)
		...
		frame.Option1.texture:SetTexture(SV.Media.setup.option)
		...
		frame.Option2.texture:SetTexture(SV.Media.setup.option)
		...
		frame.Option3.texture:SetTexture(SV.Media.setup.option)
		...
		frame.Option4.texture:SetTexture(SV.Media.setup.option)
		...
		tutorialImage:SetTexture(SV.Media.misc.splash)
