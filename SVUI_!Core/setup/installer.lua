...
function SV.Setup:Install(autoLoaded)
	...
	if not SVUI_InstallerFrame then 
		...
		frame.Next.texture:SetTexture(SV.Setup.media.arrow)
		...
		frame.Prev.texture:SetTexture(SV.Setup.media.arrow)
		...
		frame.Option01.texture:SetTexture(SV.Setup.media.option)
		...
		frame.Option02.texture:SetTexture(SV.Setup.media.option)
		...
		frame.Option03.texture:SetTexture(SV.Setup.media.option)
		...
		frame.Option1.texture:SetTexture(SV.Setup.media.option)
		...
		frame.Option2.texture:SetTexture(SV.Setup.media.option)
		...
		frame.Option3.texture:SetTexture(SV.Setup.media.option)
		...
		frame.Option4.texture:SetTexture(SV.Setup.media.option)
