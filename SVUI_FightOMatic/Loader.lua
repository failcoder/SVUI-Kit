...
SV.mediadefaults.shared.font["fightdialog"]   = {file = "SVUI Default Font", size = 12,  outline = "OUTLINE"}
SV.mediadefaults.shared.font["fightnumber"]   = {file = "SVUI Caps Font",    size = 12,  outline = "OUTLINE"}
