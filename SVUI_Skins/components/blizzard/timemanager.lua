...
local function TimeManagerStyle()
	...
	TimeManagerAlarmMessageEditBox:SetStyle()
	TimeManagerAlarmEnabledButton:SetStyle()
	TimeManagerMilitaryTimeCheck:SetStyle()
	TimeManagerLocalTimeCheck:SetStyle()
	TimeManagerStopwatchFrame:RemoveTextures()
	TimeManagerStopwatchCheck:SetStyle()
	...
	StopwatchFrame:SetStyle("Transparent")
