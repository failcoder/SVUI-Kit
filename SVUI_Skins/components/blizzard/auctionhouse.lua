...
local function AuctionStyle()
	...
	IsUsableCheckButton:SetStyle()
	ShowOnPlayerCheckButton:SetStyle()
	
	ExactMatchCheckButton:RemoveTextures()
	ExactMatchCheckButton:SetStyle()
	--SideDressUpFrame:SetPoint("LEFT", AuctionFrame, "RIGHT", 16, 0)

	AuctionProgressFrame:RemoveTextures()
	AuctionProgressFrame:SetStyle("Transparent")
	AuctionProgressFrameCancelButton:SetStyle()
	AuctionProgressFrameCancelButton:SetStyle()
	...
	AuctionFrameBrowse.bg1:SetStyle("[INSET]Transparent")
	...
	AuctionFrameBrowse.bg2:SetStyle("[INSET]Transparent")
	...
	AuctionFrameBid.bg:SetStyle("[INSET]Transparent")
	...
	AuctionFrameAuctions.bg1:SetStyle("[INSET]Transparent")
	...
	AuctionFrameAuctions.bg2:SetStyle("[INSET]Transparent")
