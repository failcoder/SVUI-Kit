...
local function GossipStyle()
	...
	ItemTextFrame:SetStyle("Pattern")
	...
	GossipFrame:SetStyle("{0}Window")
	GossipGreetingScrollFrame:SetStyle("[INSET]Transparent")
	...
	_G["GossipFrameGreetingGoodbyeButton"]:SetStyle()
	...
	NPCFriendshipStatusBar:SetStyle("Transparent")
