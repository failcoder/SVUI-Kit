...
local function TrainerStyle()
	...
	for i=1, 8 do
		...
		_G["ClassTrainerScrollFrameButton"..i]:SetStyle("{!}")
		_G["ClassTrainerScrollFrameButton"..i]:SetStyle()
	...
	_G["ClassTrainerTrainButton"]:SetStyle()
	SV.API:Set("DropDown", ClassTrainerFrameFilterDropDown, 155)
	ClassTrainerScrollFrame:SetStyle("[INSET]Transparent")
	...
	ClassTrainerFrameSkillStepButton:SetStyle()
	...
	ClassTrainerStatusBar:SetStyle("Outline", true, 1, 2, 2)
