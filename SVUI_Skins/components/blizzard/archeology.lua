...
local function ArchaeologyStyle()
	...
	ArchaeologyFrame:SetStyle("{0}Window")
	ArchaeologyFrame.Panel:SetAllPoints()
	ArchaeologyFrame.portrait:SetAlpha(0)
	ArchaeologyFrameInset:SetStyle("[INSET]Transparent")
	ArchaeologyFrameInset.Panel:SetPoint("TOPLEFT")
	ArchaeologyFrameInset.Panel:SetPoint("BOTTOMRIGHT", -3, -1)
	ArchaeologyFrameArtifactPageSolveFrameSolveButton:SetStyle()
	ArchaeologyFrameArtifactPageBackButton:SetStyle()
	...
	ArchaeologyFrameRankBar:SetStyle()
	...
	ArchaeologyFrameArtifactPageSolveFrameStatusBar:SetStyle()
	...
	for b = 1, ARCHAEOLOGY_MAX_COMPLETED_SHOWN do 
		...
		if c then 
			...
			_G["ArchaeologyFrameCompletedPageArtifact"..b.."Icon"].backdrop:SetStyle()
	...
	ArchaeologyFrameArtifactPageIcon.backdrop:SetStyle()
