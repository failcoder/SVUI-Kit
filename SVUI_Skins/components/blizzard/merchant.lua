...
local function MerchantStyle()
	...
	MerchantFrame:SetStyle("{0}Window", 2, 4)
	...
	MerchantBuyBackItem:SetStyle("[INSET]Transparent", 2, 2, 3)
	...
	MerchantBuyBackItemItemButton:SetStyle()
	...
	MerchantFrameInset:SetStyle("[INSET]Transparent")
	...
	MerchantRepairItemButton:SetStyle()
	...
	end MerchantGuildBankRepairButton:SetStyle()
	MerchantGuildBankRepairButtonIcon:SetTexCoord(0.61, 0.82, 0.1, 0.52)
	MerchantGuildBankRepairButtonIcon:InsetPoints()
	MerchantRepairAllButton:SetStyle()
