...
local function PVPFrameStyle()
	...
	HonorFrame.Inset:SetStyle("[INSET]Transparent")
	...
	HonorFrameSoloQueueButton:SetStyle()
	HonorFrameGroupQueueButton:SetStyle()
	...
	HonorFrame.BonusFrame.RandomBGButton:SetStyle()
	HonorFrame.BonusFrame.RandomBGButton:SetStyle()
	...
	HonorFrame.RoleInset.DPSIcon.checkButton:SetStyle()
	HonorFrame.RoleInset.TankIcon.checkButton:SetStyle()
	HonorFrame.RoleInset.HealerIcon.checkButton:SetStyle()
	...
	ConquestPointsBar:SetStyle("Transparent[INSET]")
	...
	ConquestJoinButton:SetStyle()
	ConquestFrame.RatedBG:RemoveTextures()
	ConquestFrame.RatedBG:SetStyle("[INSET]Transparent")
	ConquestFrame.RatedBG:SetStyle()
	...
	PVPReadyDialog:SetStyle("Pattern")
	PVPReadyDialogEnterBattleButton:SetStyle()
	PVPReadyDialogLeaveQueueButton:SetStyle()
	...
	ConquestFrame.Inset:SetStyle("[INSET]Transparent")
	WarGamesFrameScrollFrame:SetStyle("[INSET]Transparent",false,2,2,6)
