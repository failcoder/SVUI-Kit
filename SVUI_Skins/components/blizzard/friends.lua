...
local function FriendsFrameStyle()
	...
	SV.API:Set("Frame", FriendsFrame, "Window")
	...
	ChannelFrameRightInset:SetStyle("PatternModel")
	ChannelFrameLeftInset:SetStyle("PatternModel")
	LFRQueueFrameListInset:RemoveTextures()
	LFRQueueFrameRoleInset:RemoveTextures()
	LFRQueueFrameCommentInset:RemoveTextures()
	LFRQueueFrameListInset:SetStyle("PatternModel")
	FriendsFrameInset:SetStyle("PatternModel")
	--FriendsFrameFriendsScrollFrame:SetStyle("PatternModel")
	WhoFrameListInset:SetStyle("PatternModel")
	--RaidFrame:SetStyle("PatternModel")
	...
	FriendsFrameBattlenetFrame:SetStyle("[INSET]Transparent")
	...
	FriendsFrameBattlenetFrame.BroadcastButton:SetStyle()
	...
	AddFriendNameEditBox:SetStyle()
	AddFriendFrame:SetStyle("Transparent")
	ScrollOfResurrectionSelectionFrame:SetStyle("Transparent")
	ScrollOfResurrectionSelectionFrameList:SetStyle()
	SV.API:Set("ScrollFrame", ScrollOfResurrectionSelectionFrameListScrollFrameScrollBar, 4)
	ScrollOfResurrectionSelectionFrameTargetEditBox:SetStyle()
	FriendsFrameBroadcastInput:SetStyle()
	ChannelFrameDaughterFrameChannelName:SetStyle()
	ChannelFrameDaughterFrameChannelPassword:SetStyle()
	...
	ChannelFrameDaughterFrame:SetStyle("Transparent[INSET]")
	...
	FriendsFriendsFrame:SetStyle("Transparent[INSET]")

	_G["FriendsFriendsFrame"]:RemoveTextures()
	_G["FriendsFriendsList"]:RemoveTextures()
	_G["FriendsFriendsNoteFrame"]:RemoveTextures()

	_G["FriendsFriendsSendRequestButton"]:SetStyle()
	_G["FriendsFriendsCloseButton"]:SetStyle()

	FriendsFriendsList:SetStyle()
	FriendsFriendsNoteFrame:SetStyle()
	SV.API:Set("DropDown", FriendsFriendsFrameDropDown, 150)
	BNConversationInviteDialog:RemoveTextures()
	BNConversationInviteDialog:SetStyle("Transparent")
	BNConversationInviteDialogList:RemoveTextures()
	BNConversationInviteDialogList:SetStyle()
	BNConversationInviteDialogInviteButton:SetStyle()
	BNConversationInviteDialogCancelButton:SetStyle()
	for i = 1, BN_CONVERSATION_INVITE_NUM_DISPLAYED do
		 _G["BNConversationInviteDialogListFriend"..i].checkButton:SetStyle()
	end 
	FriendsTabHeaderSoRButton:SetStyle()
	FriendsTabHeaderSoRButton:SetStyle()
	...
	FriendsTabHeaderRecruitAFriendButton:SetStyle()
	FriendsTabHeaderRecruitAFriendButton:SetStyle()
	...
	FriendsFrameIgnoreScrollFrame:SetStyle("PatternModel")
	SV.API:Set("ScrollFrame", FriendsFrameIgnoreScrollFrameScrollBar, 4)
	FriendsFramePendingScrollFrame:SetStyle("[INSET]Transparent")
	...
	ScrollOfResurrectionFrameAcceptButton:SetStyle()
	ScrollOfResurrectionFrameCancelButton:SetStyle()
	...
	ScrollOfResurrectionFrameNoteFrame:SetStyle("{!}")
	ScrollOfResurrectionFrameTargetEditBox:SetStyle("{!}")
	ScrollOfResurrectionFrame:SetStyle("Transparent")
end 
--[[ 
########################################################## 
MOD LOADING
