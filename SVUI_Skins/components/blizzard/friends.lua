...
local function FriendsFrameStyle()
	...
	MOD:ApplyScrollFrameStyle(FriendsFrameFriendsScrollFrameScrollBar, 5)
	MOD:ApplyScrollFrameStyle(WhoListScrollFrameScrollBar, 5)
	MOD:ApplyScrollFrameStyle(ChannelRosterScrollFrameScrollBar, 5)
	...
	MOD:ApplyScrollFrameStyle(ScrollOfResurrectionSelectionFrameListScrollFrameScrollBar, 4)
	...
	MOD:ApplyScrollFrameStyle(FriendsFrameIgnoreScrollFrameScrollBar, 4)
	FriendsFramePendingScrollFrame:SetStylePanel("!_Frame", "Inset")
	MOD:ApplyScrollFrameStyle(FriendsFramePendingScrollFrameScrollBar, 4)
