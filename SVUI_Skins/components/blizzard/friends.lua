...
local function TabCustomHelper(this)
	...
	this.backdrop:SetStyle("Frame", "Default")
...
local function FriendsFrameStyle()
	...
	ChannelFrameRightInset:SetStyle("Frame", "PatternModel")
	ChannelFrameLeftInset:SetStyle("Frame", "PatternModel")
	LFRQueueFrameListInset:RemoveTextures()
	LFRQueueFrameRoleInset:RemoveTextures()
	LFRQueueFrameCommentInset:RemoveTextures()
	LFRQueueFrameListInset:SetStyle("Frame", "PatternModel")
	FriendsFrameInset:SetStyle("Frame", "PatternModel")
	--FriendsFrameFriendsScrollFrame:SetStyle("Frame", "PatternModel")
	WhoFrameListInset:SetStyle("Frame", "PatternModel")
	--RaidFrame:SetStyle("Frame", "PatternModel")
	...
	FriendsFrameBattlenetFrame:SetStyle("Frame[INSET]", "Transparent")
	...
	AddFriendFrame:SetStyle("Frame", "Transparent", true)
	ScrollOfResurrectionSelectionFrame:SetStyle("Frame", 'Transparent')
	ScrollOfResurrectionSelectionFrameList:SetStyle("Frame", 'Default')
	...
	BNConversationInviteDialogList:SetStyle("Frame", 'Default')
	...
	FriendsTabHeaderSoRButton:SetStyle("Frame", 'Default')
	...
	FriendsTabHeaderRecruitAFriendButton:SetStyle("Frame", 'Default')
	...
	FriendsFrameIgnoreScrollFrame:SetStyle("Frame", "PatternModel")
	SV.API:Set("ScrollFrame", FriendsFrameIgnoreScrollFrameScrollBar, 4)
	FriendsFramePendingScrollFrame:SetStyle("Frame[INSET]", "Transparent")
	...
	ScrollOfResurrectionFrameNoteFrame:SetStyle("Frame")
	ScrollOfResurrectionFrameTargetEditBox:SetStyle("Frame")
	ScrollOfResurrectionFrame:SetStyle("Frame", 'Transparent')
end 
--[[ 
########################################################## 
MOD LOADING
