...
local function StyleMoneyRewards(frameName)
  ...
  if(not frame.Panel and icon) then
      ...
      frame:SetStyle("[INSET]Transparent")
...
local function LFDFrameStyle()
  ...
  LFGDungeonReadyDialog:SetStyle("Pattern", true, 2, 4, 4)
  ...
  LFDQueueFramePartyBackfillBackfillButton:SetStyle()
  LFDQueueFramePartyBackfillNoBackfillButton:SetStyle()
  LFDQueueFrameRandomScrollFrameChildFrameBonusRepFrame.ChooseButton:SetStyle()
  ScenarioQueueFrameRandomScrollFrameChildFrameBonusRepFrame.ChooseButton:SetStyle()
  ...
  LFGDungeonReadyDialogEnterDungeonButton:SetStyle()
  LFGDungeonReadyDialogLeaveQueueButton:SetStyle()
  SV.API:Set("CloseButton", LFGDungeonReadyDialogCloseButton)

  LFGDungeonReadyStatus:RemoveTextures()
  LFGDungeonReadyStatus:SetStyle("Pattern", true, 2, 4, 4)
  ...
  LFDQueueFrameFindGroupButton:SetStyle()
  ...
  RaidFinderFrameFindRaidButton:SetStyle()
  ...
  ScenarioQueueFrameFindGroupButton:SetStyle()
  ...
  RaidBrowserFrame:SetStyle("Pattern")
  SV.API:Set("CloseButton", RaidBrowserFrameCloseButton)
  LFRQueueFrameFindGroupButton:SetStyle()
  LFRQueueFrameAcceptCommentButton:SetStyle()
  ...
  RaidBrowserFrame:HookScript('OnShow', function()
    if not LFRQueueFrameSpecificListScrollFrameScrollBar.styled then
      ...
      LFRBrowseFrameRefreshButton:SetStyle()
      LFRBrowseFrameInviteButton:SetStyle()
      LFRBrowseFrameSendMessageButton:SetStyle()
      LFRQueueFrameSpecificListScrollFrameScrollBar.styled = true 
    end 
  end)

  LFGInvitePopup:RemoveTextures()
  LFGInvitePopup:SetStyle("Pattern", true, 2, 4, 4)
  LFGInvitePopupAcceptButton:SetStyle()
  LFGInvitePopupDeclineButton:SetStyle()

  _G[LFDQueueFrame.PartyBackfill:GetName().."BackfillButton"]:SetStyle()
  _G[LFDQueueFrame.PartyBackfill:GetName().."NoBackfillButton"]:SetStyle()
  _G[RaidFinderQueueFrame.PartyBackfill:GetName().."BackfillButton"]:SetStyle()
  _G[RaidFinderQueueFrame.PartyBackfill:GetName().."NoBackfillButton"]:SetStyle()
  _G[ScenarioQueueFrame.PartyBackfill:GetName().."BackfillButton"]:SetStyle()
  _G[ScenarioQueueFrame.PartyBackfill:GetName().."NoBackfillButton"]:SetStyle()
  ...
  LFDQueueFrameRandomScrollFrame:SetStyle("Transparent")
  ScenarioQueueFrameRandomScrollFrame:SetStyle("Transparent")
  RaidFinderQueueFrameScrollFrame:SetStyle("Transparent")
  ...
  LFGListFrame.CategorySelection.StartGroupButton:SetStyle()
  LFGListFrame.CategorySelection.FindGroupButton:RemoveTextures()
  LFGListFrame.CategorySelection.FindGroupButton:SetStyle()
end
--[[ 
########################################################## 
MOD LOADING
