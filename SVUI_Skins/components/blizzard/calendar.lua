...
local function CalendarStyle()
	...
	l:SetStyle("Frame", "Default")
	l:SetPoint("TOPLEFT", 10, -72)
	l:SetPoint("BOTTOMRIGHT", -8, 3)
	CalendarContextMenu:SetStyle("Frame", "Default")
	...
	CalendarCreateEventFrame:SetStyle("Frame", "Transparent", true)
	...
	CalendarCreateEventInviteList:SetStyle("Frame", "Default")
	...
	CalendarCreateEventDescriptionContainer:SetStyle("Frame", "Default")
	...
	CalendarTexturePickerFrame:SetStyle("Frame", "Transparent", true)
	...
	CalendarMassInviteFrame:SetStyle("Frame", "Transparent", true)
	...
	CalendarViewRaidFrame:SetStyle("Frame", "Transparent", true)
	...
	CalendarViewHolidayFrame:SetStyle("Frame", "Transparent", true)
	...
	CalendarViewEventFrame:SetStyle("Frame", "Transparent", true)
	...
	CalendarViewEventDescriptionContainer:SetStyle("Frame", "Transparent", true)
	CalendarViewEventInviteList:RemoveTextures()
	CalendarViewEventInviteList:SetStyle("Frame", "Transparent", true)
	...
	CalendarEventPickerFrame:SetStyle("Frame", "Transparent", true)
