...
local function StyleVEM(event, addon)
	...
	if addon == 'VEM-GUI' then
		...
		MOD:ApplyTabStyle(VEM_GUI_OptionsFrameTab1)
		MOD:ApplyTabStyle(VEM_GUI_OptionsFrameTab2)
		VEM_GUI_OptionsFrameOkay:SetStylePanel("Button")
		VEM_GUI_OptionsFrameWebsiteButton:SetStylePanel("Button")
		MOD:ApplyScrollFrameStyle(VEM_GUI_OptionsFramePanelContainerFOVScrollBar)
