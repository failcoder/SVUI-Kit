...
local function StyleAtlasLoot(event, addon)
	...
	MOD:ApplyCloseButtonStyle(AtlasLootDefaultFrame_CloseButton)
	MOD:ApplyCloseButtonStyle(AtlasLootCompareFrame_CloseButton)
	MOD:ApplyCloseButtonStyle(AtlasLootCompareFrame_CloseButton_Wishlist)
	MOD:ApplyPaginationStyle(AtlasLootQuickLooksButton)
	MOD:ApplyPaginationStyle(AtlasLootItemsFrame_NEXT)
	AtlasLootItemsFrame_NEXT:SetWidth(25)
	AtlasLootItemsFrame_NEXT:SetHeight(25)
	MOD:ApplyPaginationStyle(AtlasLootItemsFrame_PREV)
	AtlasLootItemsFrame_PREV:SetWidth(25)
	AtlasLootItemsFrame_PREV:SetHeight(25)
	MOD:ApplyPaginationStyle(AtlasLootPanelSearch_SelectModuel)	
	MOD:ApplyPaginationStyle(AtlasLootCompareFrameSearch_SelectModuel)

	if(AtlasLootDefaultFrame_PackageSelect) then
		MOD:ApplyDropdownStyle(AtlasLootDefaultFrame_PackageSelect)
	...
	MOD:ApplyDropdownStyle(AtlasLootDefaultFrame_ModuleSelect,240)
	MOD:ApplyDropdownStyle(AtlasLootDefaultFrame_InstanceSelect,240)
	
	MOD:ApplyDropdownStyle(AtlasLootCompareFrameSearch_StatsListDropDown)
	...
	MOD:ApplyScrollFrameStyle(AtlasLootCompareFrame_ScrollFrameItemFrameScrollBar)
	MOD:ApplyScrollFrameStyle(AtlasLootCompareFrame_WishlistScrollFrameScrollBar)
